### DO-LOAD. 📦 Data Loading Task Template (v8)
...
- **Title convention:** `Data Loading: <Study Name vN>` — reuse the exact `<Study Name vN>` token from the parent Data Submission user story title (Section DO-STORY) verbatim.
