...
- *(Either way, the change always records in a CDE Request Workbook — the driver just decides which one. There is no "no workbook" path. 7f and 7g share one identical 6-section shape; pick by driver, then follow the matching template's context.)*
...
| Data Modeling for Study Submission | `claude/templates/data-modeling-study-submission-template.md` | Modeling — study-driven | ✅ Drafted v6 (2026-06-04) — converged with 7f onto one identical 6-section shape (Modeling Summary · CDE Request Workbook · DM Federal Lead & SME Review · Steps to Completion · Verification Surfaces · Notes); DM Federal Lead & SME Review required on every change (DHDM Jira Issue row 1, ServiceNow row 2) and links the DM Updates JIRA SOP; differs from 7f only by context (study workbook, Submission Portal close trigger); the ticket carries the work — no specifics, no counts; versioning governed by the SOP and tracked in GitHub | CTDC-2051 ↔ CTDC-1666 (retrofitted to v5); CTDC-1799 ↔ CTDC-1804 (pending retrofit) |
| Data Model Update Task | `claude/templates/data-model-update-template.md` | Modeling — internally / CTDC-driven | ✅ Drafted v10 (2026-06-04) — all internally-driven model changes; converged with 7g onto one identical 6-section shape (Modeling Summary · CDE Request Workbook · DM Federal Lead & SME Review · Steps to Completion · Verification Surfaces · Notes); the ticket carries the work — no specifics, no counts; versioning governed by the SOP and tracked in GitHub; records in the internal CTDC CDE Request Workbook (owned by the project, no individual owner); DM Federal Lead & SME Review required on every change (DHDM Jira Issue row 1, ServiceNow row 2), links the DM Updates JIRA SOP, gates prod | CTDC-2068 (Program curation properties — canonical pilot) |
