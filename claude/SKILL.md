...
*Data-related epics use the data variant in 7b-D* (Gina, 2026-09-25). Submission Data Modeling and Internal Data Modeling are standing epics that stay Open and carry a Risks table; they are migrated with 7b-D, not this template. Each study submission is its own closing epic on the Data Submission Epic template (DO-EPIC, 2026-09-25), piloted on CTDC-2110 (CMB v6). The Data Integration epic (CTDC-1664) stays Open as a standing operational epic on this template (7b), in the same shape as Software Release Deployments (CTDC-2007): it holds integration work no single submission owns (cross-study loading and indexing, engineering and data modeling support, migrations and corrections of existing data, cross-study plans and logs). Model changes live in the modeling epics, and deployments of data-driven code live in Software Release Deployments (Gina, 2026-09-25). Mock Data Generation was reclassified the same day as a feature epic (its outputs serve data submitters, but it closes when delivered) and is migrated with this template.
