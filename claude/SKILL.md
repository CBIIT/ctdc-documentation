...
| Data Modeling for Study Submission | `claude/templates/data-modeling-study-submission-template.md` | Modeling — study-driven | ✅ Drafted v9 (2026-07-20) — 5-section shape (Modeling Summary · CDE Request Workbook · DM Federal Lead & SME Review · Steps to Completion · Verification Surfaces); re-synced to finalized CTDC-2051: Section 3 row 3 is now the **caDSR II Help Desk Request Form** (owner: Data Concierge; DM Fed Lead added as watcher on the caDSR ticket), replacing the earlier "ServiceNow Ticket / DM Fed Lead"; Steps to Completion expanded from a 4-step spine to the fuller canonical workflow (caDSR filing detail with 1:1 Short-Description title rule, SI-team curation, PR links in comments, Ready-for-QA, don't-close-until-submission-complete); Verification Surfaces across the two Data Model Navigator instances (CRDC Submission Portal + CTDC); milestone tracker — no specifics, no counts | CTDC-2051 ↔ CTDC-1666 (canonical, drove v9); CTDC-1799 ↔ CTDC-1804 (pending retrofit to v9) |
| Data Model Update Task | `claude/templates/data-model-update-template.md` | Modeling — internally / CTDC-driven | ✅ Drafted v14 (2026-07-20) — all internally-driven model changes, any SemVer level (additive through breaking); 5-section shape identical to 7f (v9); re-synced to finalized CTDC-2068 in lockstep with 7f: Section 3 row 3 is now the **caDSR II Help Desk Request Form** (owner: Data Concierge), replacing "ServiceNow Ticket / DM Fed Lead"; Steps to Completion expanded to the fuller canonical workflow with conditional watcher logic (DM Fed Lead added on the Jira issue when no CDEs/PVs change, on the caDSR ticket when they do); milestone tracker — no specifics, no counts; records in the internal CTDC CDE Request Workbook (owned by the project, no individual owner); DM Federal Lead & SME Review (caDSR II Help Desk Request Form + DHDM Jira Issue) gates prod | CTDC-2068 (Program curation properties — canonical pilot) |
